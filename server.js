...
const app = express();
const PORT = process.env.PORT || 3002; // Changed from 3001 to avoid potential conflicts
...
const server = app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`API endpoint available at: http://127.0.0.1:${PORT}/api/cortex-agent`);
});
